...
public class RouteTests
{
    ...
    {
        var train = new Train(2000, 2000, 0.01);
        ...
        RouteResult simulationResult = simulationService.RunSimulation();
    ...
    {
        var train = new Train(1000, 500, 0.1f);
    ...
    {
        var train = new Train(1500, 800, 0.5);
    ...
    {
        var train = new Train(100, 800, 0.01f);
    ...
    {
        var train = new Train(1000, 1000, 0.1);
    ...
    {
        var train = new Train(1000, 1500, 1);
    ...
    {
        var train = new Train(1500, 600, 0.1);
